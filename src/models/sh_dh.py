...
if MAKEFIGS:
    ...
    if MAKEVIDS:
        ...
        generate_video(f,50,'figs/mov/sh-dh',framerate=6,
                   filename=f"figs/{figbasename}_train_{l1_size}_{l2_size}",rm_images=True,transparent=False)
        ...
        generate_video(g,50,'figs/mov/sh-dh',framerate=6,
                   filename=f"figs/{figbasename}_valid_{l1_size}_{l2_size}",rm_images=True,transparent=False)